...
- **Next.js integration** — works with no configuration since Next.js 16.3 (`experimental.viewTransition` flag on 15 canary – 16.2), `transitionTypes` on `next/link` and `useRouter`, App Router patterns
